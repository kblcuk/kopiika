...
export function EntityFilter({ selectedEntityId, onChange }: EntityFilterProps) {
	...
	return (
		<>
			...
			<PageSheetModal visible={visible} onRequestClose={() => setVisible(false)}>
				{/* Header */}
				<View className="flex-row items-center justify-between border-b border-paper-300 px-5 py-4">
					<Text className="font-sans-semibold text-base text-ink">Filter by Entity</Text>
				...
				<ScrollView className="flex-1">
					...
					>
						<Text className="font-sans-medium text-base text-ink">All Entities</Text>
					</Pressable>
