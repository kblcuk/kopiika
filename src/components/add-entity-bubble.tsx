...
export function AddEntityBubble({ type, onPress }: AddEntityBubbleProps) {
	return (
		<Pressable onPress={() => onPress(type)} className="w-[25%] items-center py-1.5">
			...
			<View className="relative mb-1.5 h-14 w-14 items-center justify-center">
				<View
					className="h-14 w-14 items-center justify-center rounded-full border-2 border-dashed border-paper-400"
