...
export function RefundPickerModal({
	...
	return (
		<PageSheetModal visible={visible} onRequestClose={onClose} testID="refund-picker-modal">
			{/* Header */}
										...
										<View className="flex-row items-center">
											...
											>
												<FromIcon
													size={16}
													color={
														fromColors?.iconColor ?? colors.ink.muted
													}
												/>
											</View>
											<Text
											...
											<View
												className="mr-2 h-8 w-8 items-center justify-center rounded-full"
												style={{
													backgroundColor: toColors?.bgColor ?? '#EBE3D5',
												}}
											>
												<ToIcon
													size={16}
													color={toColors?.iconColor ?? colors.ink.muted}
												/>
											</View>
											<Text
